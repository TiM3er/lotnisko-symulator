...
public class Zglaszaj extends BasicSimEvent<Otoczenie, Object> {
    ...
    protected void stateChange() throws SimControlException {
        ...
        zgl.setPriority(generator.uniformInt(1, 50));
        System.out.println(simTime() + " - " + simDate(SimDateField.HOUR24) + " - " + simDate(SimDateField.MINUTE) + " - " + simDate(SimDateField.SECOND) + " - " + simDate(SimDateField.MILLISECOND) + ": Otoczenie- Dodano nowe zgl. nr: " + zgl.getTenNr() + " priorytet " + zgl.getPriority());
