...
public class ZakonczObsluge extends BasicSimEvent<Smo, Zgloszenie>
{
	...
	protected void stateChange() throws SimControlException {
        ...
        System.out.println(simTime()+" - "+simDate(SimDateField.HOUR24)+" - "+simDate(SimDateField.MINUTE)+" - "+simDate(SimDateField.SECOND)+" - "+simDate(SimDateField.MILLISECOND)+": SMO- Koniec obsługi zgl. nr: " + transitionParams.getTenNr() + " priorytet "+transitionParams.getPriority());
