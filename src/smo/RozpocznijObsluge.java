...
public class RozpocznijObsluge extends BasicSimEvent<Smo, Zgloszenie>
{
	...
	protected void stateChange() throws SimControlException {
        if (smoParent.liczbaZgl() > 0)
        {
            ...
            System.out.println(simTime()+" - "+simDate(SimDateField.HOUR24)+" - "+simDate(SimDateField.MINUTE)+" - "+simDate(SimDateField.SECOND)+" - "+simDate(SimDateField.MILLISECOND)+": SMO- Początek obsługi zgl. nr: " + zgl.getTenNr()+ " priorytet " + zgl.getPriority());
